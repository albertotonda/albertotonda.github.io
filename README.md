...
2. Add publications (i) upload a file called "publications.bib" in the root of the repository from the GitHub website; this will automatically create a merge request with the pages automatically generated by a script. It might take a few minutes. Accept the merge.
...
NOTE: At the moment, there is no git integration for PLMLatex, so the files have to be manually downloaded
...
4. Remove the "publications.bib" file there
